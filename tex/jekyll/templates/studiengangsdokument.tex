...
\newcommand{\docname}{Studiengangsdokument}

% Farben definieren
\usepackage{color}
\usepackage[html]{xcolor}
\definecolor{m_green}{HTML}{b43092}
%\definecolor{m_pink}{HTML}{D40B6F}
\definecolor{m_pink}{HTML}{b43092}
\definecolor{m_grey}{HTML}{555555}
\definecolor{m_lila}{HTML}{b43092}
\definecolor{m_blau}{HTML}{b43092}
...
\rfoot{\thepage}
\lfoot{\changefont Studiengangsdokument | Code \& Context | TH Köln}
...
\usepackage[pdftex,plainpages=false,pdfpagelabels,
            pdftitle={Studiengangsdokument | Code \& Context | TH Köln},
            pdfauthor={}
            ]{hyperref}
\hypersetup{
    colorlinks = true,
...
%\newwatermark[allpages,color=gray,angle=45,scale=3]{Arbeitsversion}

\usepackage[raggedright]{titlesec}
\titleformat{\chapter}[display]
  {\normalfont\sffamily\mdseries}
  {}{14pt}{\huge\color{m_pink}\thechapter\quad\raggedright}
% {\ \thechapter}{14pt}{\huge\raggedright}
\titleformat{\section}
...
\renewcommand*\bibname{Vorl. Literaturverzeichnis}
